...
public class FormGuestController implements Initializable, UpdateObserver {
    @FXML
    private Button btnSugAnimal;
    @FXML
    private Button btnTakeAnimal;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources){
        ...
        imgBoxBack.setOnMouseClicked(e -> {
            Parent root;
            try {
                Stage thisStage = (Stage) btnTakeAnimal.getScene().getWindow();
                thisStage.close();
        ...
        // обработчики кнопок
        btnSugAnimal.setOnAction(new EventHandler<ActionEvent>() {
                                   public void handle(ActionEvent event) {
                                       Parent root;
                                       try {
                                           root = FXMLLoader.load(ShelterApplication.class.getResource("formGiveAnimal.fxml"), resources);
                                           Stage stage = new Stage();
                                           String projectPath = System.getProperty("user.dir");
                                           String imgPath = projectPath + File.separator + "src" + File.separator +
                                                   "main" + File.separator + "resources" + File.separator +
                                                   "images" + File.separator + "logo.jpg";
                                           stage.getIcons().add(new Image(imgPath));
                                           stage.setTitle("Предложите животное");
                                           stage.initStyle(StageStyle.UNDECORATED);
                                           stage.setResizable(false);
                                           stage.setScene(new Scene(root, 800, 600));
                                           stage.show();
        ...
        btnTakeAnimal.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                openTakeAnimalForm();
            }
        });

        btnCharity.setOnAction(new EventHandler<ActionEvent>() {
                                   public void handle(ActionEvent event) {
                                       Parent root;
                                       try {
                                           root = FXMLLoader.load(ShelterApplication.class.getResource("formCharity.fxml"), resources);
                                           Stage stage = new Stage();
                                           String projectPath = System.getProperty("user.dir");
                                           String imgPath = projectPath + File.separator + "src" + File.separator +
                                                   "main" + File.separator + "resources" + File.separator +
    ...
    @FXML
    private void openTakeAnimalForm() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("formTakeAnimal.fxml"));
            ...
            String imgPath = projectPath + File.separator + "src" + File.separator +
                    ...
                    "images" + File.separator + "logo.jpg";
            stage.getIcons().add(new Image(imgPath));
            stage.setTitle("Возьмите животное");
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setResizable(false);
            stage.setScene(new Scene(root, 800, 600));
            stage.show();
            ...
            FormTakeAnimalController controller = (FormTakeAnimalController) loader.getController();
