...
public class FormMainController implements Initializable, UpdateObserver  {
    @FXML
    private TextField txtSearchAnimal;
    @FXML
    private Button btnAddCart;
    @FXML
    private Button btnDelCart;
    @FXML
    private Button btnRedCart;
    @FXML
    private Button btnFormRes;
    @FXML
    private Button btnShowStat;
    @FXML
    private Button btnAcceptAnimals;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources){
        ...
        imgBoxBack.setOnMouseClicked(e -> {
            Parent root;
            try {
                Stage thisStage = (Stage) btnAddCart.getScene().getWindow();
                thisStage.close();
        ...
        btnDelCart.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                openDelForm();
            }
        });
        // кнопка редактирования карточек
        btnRedCart.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                openRedForm();
            }
        });
        btnFormRes.setOnAction(new EventHandler<ActionEvent>() {
                                    public void handle(ActionEvent event) {
                                        Parent root;
                                        try {
                                            root = FXMLLoader.load(ShelterApplication.class.getResource("formSummary.fxml"), resources);
                                            Stage stage = new Stage();
                                            String projectPath = System.getProperty("user.dir");
                                            String imgPath = projectPath + File.separator + "src" + File.separator +
                                                    "main" + File.separator + "resources" + File.separator +
                                                    "images" + File.separator + "logo.jpg";
                                            stage.getIcons().add(new Image(imgPath));
                                            stage.setTitle("Получение отчета"); 
                                            stage.initStyle(StageStyle.UNDECORATED);
                                            stage.setResizable(false);
        ...
        btnAcceptAnimals.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                openAcceptAnimalsForm();
            }
        });
        btnShowStat.setOnAction(new EventHandler<ActionEvent>() {
                                public void handle(ActionEvent event) {
                                    Parent root;
                                    try {
                                        root = FXMLLoader.load(ShelterApplication.class.getResource("formInnerSummary.fxml"), resources);
                                        Stage stage = new Stage();
                                        String projectPath = System.getProperty("user.dir");
                                        String imgPath = projectPath + File.separator + "src" + File.separator +
                                                "main" + File.separator + "resources" + File.separator +
                                                "images" + File.separator + "logo.jpg";
                                        stage.getIcons().add(new Image(imgPath));
                                        stage.setTitle("Статистика приюта");
                                        stage.initStyle(StageStyle.UNDECORATED);
                                        stage.setResizable(false);
                                        stage.setScene(new Scene(root, 800, 600));
                                        stage.show();
    ...
    private void openAddForm() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("formAdd.fxml"));
            ...
            String imgPath = projectPath + File.separator + "src" + File.separator +
                    ...
                    "images" + File.separator + "logo.jpg";
            stage.getIcons().add(new Image(imgPath));
            stage.setTitle("Добавление карточки");
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setResizable(false);
            stage.setScene(new Scene(root, 800, 600));
            stage.show();
            ...
            FormAddController controller = (FormAddController) loader.getController();
    ...
    private void openDelForm() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("formDel.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
            String projectPath = System.getProperty("user.dir");
            String imgPath = projectPath + File.separator + "src" + File.separator +
                    ...
                    "images" + File.separator + "logo.jpg";
            stage.getIcons().add(new Image(imgPath));
            stage.setTitle("Удаление карточки");
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setResizable(false);
            stage.setScene(new Scene(root, 800, 600));
            stage.show();
            ...
            // Передаем экземпляр главной формы в FormAddController
            FormDelController controller = (FormDelController) loader.getController();
            controller.setObserver(this);
        } catch (IOException e) {
            lblError.setText("Невозможно открыть форму!");
            e.printStackTrace();
    ...
    @FXML
    private void openRedForm() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("formRed.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
            String projectPath = System.getProperty("user.dir");
            String imgPath = projectPath + File.separator + "src" + File.separator +
                    ...
                    "images" + File.separator + "logo.jpg";
            stage.getIcons().add(new Image(imgPath));
            stage.setTitle("Редактирование карточки");
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setResizable(false);
            stage.setScene(new Scene(root, 800, 600));
            stage.show();
            ...
            // Передаем экземпляр главной формы в FormAddController
            FormRedController controller = (FormRedController) loader.getController();
            controller.setObserver(this);
        } catch (IOException e) {
            lblError.setText("Невозможно открыть форму!");
            e.printStackTrace();
    ...
    @FXML
    private void openAcceptAnimalsForm() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("formAcceptAnimals.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
            String projectPath = System.getProperty("user.dir");
            String imgPath = projectPath + File.separator + "src" + File.separator +
                    ...
                    "images" + File.separator + "logo.jpg";
            stage.getIcons().add(new Image(imgPath));
            stage.setTitle("Принять животное");
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setResizable(false);
            stage.setScene(new Scene(root, 800, 600));
            stage.show();
            ...
            // Передаем экземпляр главной формы в FormAddController
            FormAcceptAnimalsController controller = (FormAcceptAnimalsController) loader.getController();
            controller.setObserver(this);
        } catch (IOException e) {
            lblError.setText("Невозможно открыть форму!");
            e.printStackTrace();
